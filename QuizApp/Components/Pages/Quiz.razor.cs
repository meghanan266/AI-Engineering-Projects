...
public partial class Quiz(IChatClient chatClient) : ComponentBase
{
    ...
    private const string QuizSubject = "Artificial Intelligence";
    ...
    the answer only needs to be a single word or phrase. Don't repeat these questions that you already asked: {previousQuestions}
    """;
    ...
    """;
        ...
        lastAnswerCorrect = currentQuestionOutcome.StartsWith("CORRECT");
